...
const Settings: React.FC = () => {
  ...
  const [activeTab, setActiveTab] = useState<'branding' | 'tones' | 'feedback'>('branding');
  ...
  const handleFeedbackStatusUpdate = async (id: string, status: FeedbackEntry['status']) => {
    setIsSubmitting(true);
    await new Promise(resolve => setTimeout(resolve, 500));
  ...
  const getStatusIcon = (status: FeedbackEntry['status']) => {
    switch (status) {
      case 'new': return <Flag className="h-4 w-4" />;
    ...
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-lg text-gray-600">Manage site configuration and user feedback</p>
        </div>
              ...
              <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                <div className="flex items-center justify-between mb-6">
                  <div className="flex items-center space-x-2">
                    ...
                    <h2 className="text-xl font-bold text-gray-900">Tone Presets</h2>
                  </div>
                  <button
                  ...
                  <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
                    <div className="bg-white rounded-xl shadow-xl max-w-md w-full p-6">
                      <h3 className="text-lg font-bold text-gray-900 mb-4">
                        {tonePresets.find(t => t.id === editingTone.id) ? 'Edit Tone' : 'Add New Tone'}
                      </h3>
                      ...
                      <div className="space-y-4">
                        <div>
                          ...
                          <input
                            ...
                            onChange={(e) => setEditingTone(prev => prev ? { ...prev, name: e.target.value } : null)}
                        ...
                        <div>
                          ...
                          <textarea
                            ...
                            onChange={(e) => setEditingTone(prev => prev ? { ...prev, description: e.target.value } : null)}
                            rows={3}
                            className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500"
                          />
                        </div>
                        ...
                        <div>
                          ...
                          <input
                            ...
                            onChange={(e) => setEditingTone(prev => prev ? { 
                              ...prev, 
                ...
                <form onSubmit={handleToneSubmit}>
                  <div className="flex justify-end">
                    ...
                    >
                      <Save className="h-4 w-4" />
                      <span>{isSubmitting ? 'Saving...' : 'Save Tone Settings'}</span>
                    </button>
                  </div>
                </form>
              </div>
            ...
            {activeTab === 'feedback' && (
              <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                    ...
                    <div className="flex items-center">
                      ...
                      <div>
                        ...
                        <p className="text-2xl font-bold text-blue-900">
                          {feedbackEntries.filter(f => f.status === 'new').length}
                        </p>
                      </div>
                    </div>
                  </div>
                    ...
                    <div className="flex items-center">
                      ...
                      <div>
                        ...
                        <p className="text-2xl font-bold text-orange-900">
                          {feedbackEntries.filter(f => f.status === 'in_progress').length}
                        </p>
                      </div>
                    </div>
                  </div>
                    ...
                    <div className="flex items-center">
                      ...
                      <div>
                        ...
                        <p className="text-2xl font-bold text-red-900">
                          {feedbackEntries.filter(f => f.priority === 'high').length}
                        </p>
                      </div>
                    </div>
                  </div>
                    ...
                    <div key={feedback.id} className="border border-gray-200 rounded-lg p-4">
                      <div className="flex items-start justify-between">
                        ...
                        <div className="flex flex-col space-y-2 ml-4">
                          {!feedback.assignedTo && (
                            <button
                              onClick={() => handleAssignFeedback(feedback.id)}
                              disabled={isSubmitting}
                          ...
                          <select
                            ...
                            onChange={(e) => handleFeedbackStatusUpdate(feedback.id, e.target.value as FeedbackEntry['status'])}
                            disabled={isSubmitting}
                ...
                {selectedFeedback && (
                  <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
                    <div className="bg-white rounded-xl shadow-xl max-w-md w-full p-6">
                      <h3 className="text-lg font-bold text-gray-900 mb-4">Add Admin Notes</h3>
                      ...
                      <div className="flex space-x-3 mt-4">
                        <button
                          onClick={() => {
                            const feedback = feedbackEntries.find(f => f.id === selectedFeedback);
                            if (feedback) {
                              handleFeedbackStatusUpdate(selectedFeedback, feedback.status);
                            }
                          }}
                          disabled={isSubmitting}
                ...
                {feedbackEntries.length === 0 && (
                  <div className="text-center py-12">
                    ...
                    <h3 className="text-lg font-medium text-gray-900 mb-2">No feedback entries</h3>
